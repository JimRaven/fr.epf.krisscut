								...
								<div class="col-xs-12">
									<form action="" method="post" class="">
										<div class="form-group">
											<label for="birth">Birth date :</label> <input type="text"
												class="input-lg form-control" name="birth" id="birth"
												value="<c:out value = "${employeeBirth}"/>">
										</div>

										<div class="form-group">
											<label for="email">Email</label> <input type="email"
												class="input-lg form-control" name="email" id="email"
												value="<c:out value = "${employee.email}"/>">
										</div>

										<div class="form-group">
											<label for="name">Name</label> <input type="text"
												class="input-lg form-control" name="name" id="name"
										...
										<div class="form-group">
											<label for="password">Password</label> <input type="password"
												...
												value="<c:out value = "${employee.pass}"/>">
										</div>

										<p>
											Make this member an administrator&nbsp; <input name="admin"
												type="checkbox" ${isAdmin} />
										</p>

										<label for="error"><c:out value="${error}" /></label> <input
											type="text" value="save" class="hidden" name="action">
										<input type="text" value="<c:out value = "${employee.id}"/>"
											class="hidden" name="id"> <input type="text"
											value="<c:out value = "${employee.login}"/>" class="hidden"
											name="login">
