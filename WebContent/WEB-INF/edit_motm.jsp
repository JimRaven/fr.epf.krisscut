								...
								<div class="col-lg-12">
									...
									<div class="description">
										...
										<ul>
											...
											<li>A <b>form template</b>: this content will be
												displayed on the page where each employee can vote
											</li>
										</ul>
										Template tokens: You can use the following tokens anywhere in
										each content:
										<ul>
											<li><b>${name}</b>: the user name</li>
											<li><b>${link}</b>: the link to the MOTM for the current
												user</li>
											<li><b>${currentMonth}</b>: the current month (ex:
												January)</li>
										</ul>
									</div>
								</div>
									...
									<form action="" method="post" class="">
										<div class="form-group">
											<label for="name">Subject</label> <input type="text"
												name="subject" class="input-lg form-control" id="name"
												value="Hey ${name}, let's hear it for your mood of the month!">
										</div>
										<div class="form-group">
											<label for="email-template">Email template (<a
												href="newsletter" target="_blank">check the email
													template</a>)
											</label>
